...
Исчисление предикатов семантически полно.
...
\subsubsection{Натуральные числа: аксиоматика Пеано, 1889}
...
\noindent {\bf Определение.} Непротиворечивость — свойство формальной системы, состоящее в том, что не каждая формула этой системы доказуема в ней. 
...
\noindent {\bf Определение.}  Лямбда-термы.
\begin{enumerate}
\item Переменная $x$.
